...
const QuizScreen = (navigation: any) => {
    ...
    const setNextQuestion = () => {
        ...
        setSelectedIndex(-1);
        console.log('incremented to '+questionIndex+1);
                ...
                questions.length ?
                    <View style={styles.loginScreen}>
                        <View style={{ flexDirection: 'row' }}>
                            ...
                            <Text style={{ fontSize: 20, color: 'white', fontWeight: '700', marginLeft: 150 }}>
                                {questionIndex + 1} of 10
                            </Text>
                        </View>
                        <View style={{ width: 370, backgroundColor: '#5e69ee', borderColor: 'white', borderBottomColor: 'white', borderWidth: 1, marginTop: 1 }}></View>
                        <View>
                            ...
                            <TouchableOpacity onPress={() => verifyAnswer(options[2], 2)}>
                                <View style={styles.optionStyle}>
                                    <Text style={selectedIndex==0?styles.SelectedOptionNo:styles.optionNo}>C</Text>
                                    <Text style={styles.optionTextStyle}>{decodeURIComponent(options[2])}</Text>
                                </View>
                            </TouchableOpacity>
                            <TouchableOpacity onPress={() => verifyAnswer(options[3], 3)}>
                                <View style={styles.optionStyle}>
                                    <Text style={selectedIndex==0?styles.SelectedOptionNo:styles.optionNo}>D</Text>
                    ...
                    : <View><ActivityIndicator color={'green'} size={200}></ActivityIndicator></View>
            }
        </View>
    );
}
